...
export function PageIntro({ eyebrow, title, children }: { eyebrow: string; title: string; children: ReactNode }) {
  return <header className="border-b border-gold/25 px-6 pb-14 pt-24 md:px-14 md:pt-16"><div className="mx-auto max-w-6xl"><p className="mb-4 font-mono text-xs uppercase text-cinnabar">{eyebrow}</p><h1 className="font-display text-5xl md:text-7xl">{title}</h1><p className="mt-5 max-w-2xl text-base leading-8 text-ink/65">{children}</p></div></header>;
}